...
?>
  ...
  <script type="text/javascript" language="javascript">
    ...
    function cadveic(){
      ...
      document.getElementById('cad_cat').type = 'text';
        ...
        <form id="form" action="#" method="POST">
          <div class="painel_conteudo row">
            ...
            <div class="col-sm-12 conteudo form-group form_cad_vaga">
              ...
              <input type="hidden" id="cad_placa" name="cad_placa" class="form-control" placeholder="Placa do Veículo" maxlength="11" pattern="[A-Za-z]{3}[0-9]{4}" >
              ...
              <input type="hidden" id="cad_ano" name="cad_ano" class="form-control" placeholder="Ano do Veículo" pattern="[0-9]{4}" maxlength="4">
              <input type="hidden" id="cad_cat" name="cad_cat" class="form-control" placeholder="Categoria (Nome)">

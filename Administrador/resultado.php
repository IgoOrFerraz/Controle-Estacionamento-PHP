          ...
          if(isset($_GET['resul'])){
            ...
            if($_GET['resul'] == 'vaga'){
              echo"
                <div class='principal'>
                    <div class='corpo'>
                      <div class='container campo_resultado'>
                        ...
                        <form action='#' method='POST'>
                          <div class='painel_conteudo row'>
                            <div class='col-sm-12 conteudo-direito form-group'>
                            
                              <label class='resultado' for='campo1'>ID Vaga</label>
                              <input type='text' id='campo1' name='campo1' class='form-control' value = ".$_SESSION['cod_vaga']." readonly>

                              <label class='resultado' for='campo2'>Categoria</label>
                              <input type='text' id='campo2' name='campo2' class='form-control' value = ".$_SESSION['nome_cat']." readonly>

                              <label class='resultado' for='campo3'>Preço por Hora</label>
                              <input type='text' id='campo3' name='campo3' class='form-control' value = ".$_SESSION['preco_cat']." readonly>
            ...
            if($_GET['resul'] == 'relres'){
              
              
              echo"
                <div class='principal'>
                    <div class='corpo'>
                      <div class='container campo_resulrel'>
          
                        <div class='container logotipo'></div><br>
                        <h3 style='text-align: center; font-size: 20px; font-weight: bold'>Relatório Reservas</h3>
          
                        <hr>
                          <div class='painel_conteudo row'>
                            <div class='col-sm-12 conteudo-direito'>";
                              
                              $result = explode(';', $_SESSION['rel']);
                              ...
                              for($cont=0;$result[$cont]!=null;$cont++){
                                ...
                                echo "
                                  <div class='col-sm-12 resul row' style='font-size: 15px;'>
                                    <span>Data_Reserva: </span> $cadaresult[0] 
                                    <span>Hora_Inicio: </span> $cadaresult[1] 
                                    <span>Hora_Fim: </span> $cadaresult[2] 
                                    <span>Vaga: </span> $cadaresult[3]
                                    <span>Veículo: </span> $cadaresult[4]
                                    <span>Dono Veic: </span> $cadaresult[5]
                                  </div>
                ...
                <div class='principal'>
                    <div class='corpo'>
                      <div class='container campo_resulrel'>
                        ...
                        <div class='container logotipo'></div><br>
                        <h3 style='text-align: center; font-size: 20px; font-weight: bold'>Relatório Clientes</h3>
                          ...
                          <div class='painel_conteudo row'>
                            <div class='col-sm-12 conteudo-direito'>";
                              ...
                              for($cont=0;$result[$cont]!=null;$cont++){
                                ...
                                echo "
                                  <div class='col-sm-12 resul row' style='font-size: 15px;'>
                                    <span>CPF: </span> $cadaresult[0] 
                                    <span>Nome: </span> $cadaresult[1] 
                                    <span>E-Mail: </span> $cadaresult[2] 
                                    <span>Data_Nasc: </span> $cadaresult[3]
                                    <span>Fone: </span> $cadaresult[4]
                                    <span>Endereço: </span> $cadaresult[5]
                                    <span>Bairro: </span> $cadaresult[6]
                                    <span>Cidade: </span> $cadaresult[7]
                                  </div>
                ...
                <div class='principal'>
                    <div class='corpo'>
                      <div class='container campo_resulrel'>
                        ...
                        <div class='container logotipo'></div><br>
                        <h3 style='text-align: center; font-size: 20px; font-weight: bold'>Relatório Veículos</h3>
                          ...
                          <div class='painel_conteudo row'>
                            <div class='col-sm-12 conteudo-direito'>";
                              ...
                              for($cont=0;$result[$cont]!=null;$cont++){
                                ...
                                echo "
                                  <div class='col-sm-12 resul row' style='font-size: 15px;'>
                                    <span>ID: </span> $cadaresult[0] 
                                    <span>Placa: </span> $cadaresult[1] 
                                    <span>Modelo: </span> $cadaresult[2] 
                                    <span>Cor: </span> $cadaresult[3]
                                    <span>Ano: </span> $cadaresult[4]
                                    <span>CPF_Dono: </span> $cadaresult[5]
                                    <span>Categoria: </span> $cadaresult[8]
                                  </div>
            ...
            if($_GET['resul'] == 'relvag'){
              
              
              echo"
                <div class='principal'>
                    <div class='corpo'>
                      <div class='container campo_resulvag'>
          
                        <div class='container logotipo'></div><br>
                        <h3 style='text-align: center; font-size: 20px; font-weight: bold'>Relatório Vagas</h3>
                          ...
                          <div class='painel_conteudo row'>
                            <div class='col-sm-12 conteudo-direito'>";
                              ...
                              for($cont=0;$result[$cont]!=null;$cont++){
                                ...
                                echo "
                                  <div class='col-sm-12 resul row' style='font-size: 15px;'>
                                    <span>ID_Vaga: </span> $cadaresult[0] 
                                    <span>Categoria: </span> $cadaresult[3] 
                                    <span>Preço (R$): </span> $cadaresult[4]
                                  </div>
